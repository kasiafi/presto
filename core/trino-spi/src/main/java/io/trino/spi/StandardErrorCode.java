        ...
        implements ErrorCodeSupplier
{
    ...
    INVALID_LABEL(95, USER_ERROR),
    INVALID_PROCESSING_MODE(96, USER_ERROR),
    INVALID_NAVIGATION_NESTING(97, USER_ERROR),
    INVALID_ROW_PATTERN(98, USER_ERROR),
    NESTED_ROW_PATTERN_RECOGNITION(99, USER_ERROR),
    TABLE_HAS_NO_COLUMNS(100, USER_ERROR),
    INVALID_RANGE(101, USER_ERROR),
