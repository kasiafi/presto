...
{
    private final Optional<Expression> atLeast;
    private final Optional<Expression> atMost;

    public RangeQuantifier(boolean greedy, Optional<Expression> atLeast, Optional<Expression> atMost)
    {
        this(Optional.empty(), greedy, atLeast, atMost);
    }

    public RangeQuantifier(NodeLocation location, boolean greedy, Optional<Expression> atLeast, Optional<Expression> atMost)
    {
        this(Optional.of(location), greedy, atLeast, atMost);
    }

    private RangeQuantifier(Optional<NodeLocation> location, boolean greedy, Optional<Expression> atLeast, Optional<Expression> atMost)
    {
    ...
    public Optional<Expression> getAtLeast()
    {
        return atLeast;
    }

    public Optional<Expression> getAtMost()
    {
        return atMost;
    }
