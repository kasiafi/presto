        ...
        extends AstVisitor<Void, C>
{
    ...
    @Override
    protected Void visitGroupedPattern(GroupedPattern node, C context)
    {
        process(node.getPattern(), context);
    ...
    @Override
    protected Void visitPatternNavigationFunction(PatternNavigationFunction node, C context)
    {
        process(node.getArgument(), context);
